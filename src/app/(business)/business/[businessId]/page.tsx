  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 via-violet-50 to-indigo-50">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        <div className="absolute left-1/4 top-1/4 h-72 w-72 rounded-full bg-violet-200 blur-[100px] opacity-60" />
        <div className="absolute right-1/4 bottom-1/4 h-56 w-56 rounded-full bg-indigo-200 blur-[80px] opacity-50" />
      </div>
      ...
      <div className="relative w-full max-w-[420px] px-4">
        ...
        <div className="rounded-2xl border border-border bg-card shadow-xl ring-1 ring-black/5">
          <div className="h-1 w-full rounded-t-2xl bg-gradient-to-r from-violet-500 via-violet-400 to-indigo-500" />
